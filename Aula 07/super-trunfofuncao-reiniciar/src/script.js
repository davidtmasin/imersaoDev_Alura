...
function reiniciar(){
  ...
  var removeRadioAtributo = document.getElementsByName('attribute')
  for(var i = 0; i < removeRadioAtributo.length; i++){
      removeRadioAtributo[i].disabled = true
    }
  
  var removeIMG = document.getElementById('card-player')
